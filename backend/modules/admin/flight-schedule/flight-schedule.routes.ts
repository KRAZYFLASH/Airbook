...
const flightScheduleController = new FlightScheduleController(
  flightScheduleService
);

// Bind methods to preserve 'this' context
const getAllFlightSchedules =
  flightScheduleController.getAllFlightSchedules.bind(flightScheduleController);
const getFlightScheduleById =
  flightScheduleController.getFlightScheduleById.bind(flightScheduleController);
const createFlightSchedule = flightScheduleController.createFlightSchedule.bind(
  flightScheduleController
);
const updateFlightSchedule = flightScheduleController.updateFlightSchedule.bind(
  flightScheduleController
);
const deleteFlightSchedule = flightScheduleController.deleteFlightSchedule.bind(
  flightScheduleController
);
